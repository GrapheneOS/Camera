...
class CameraSessionPlanFactoryTest {

    @Test
    fun create_photoMode_buildsAPhotoAndPreviewSession() {
    ...
    @Test
    fun create_videoModeWithoutPhotoCapture_buildsNoImageCapture() {
        val plan = buildPlan(
    ...
    @Test
    fun create_focusLockWinsOverZeroShutterLag() {
    ...
    @Test
    fun create_zeroShutterLagAlone_isRequested() {
    ...
    @Test
    fun create_neitherFocusLockNorZeroShutterLag_minimizesLatency() {
        val plan = buildPlan(request())
    ...
    @Test
    fun create_theRequestedFlashAndRotation_reachTheImageCapture() {
        val plan = buildPlan(
    ...
    @Test
    fun create_aFeatureGroupSession_leadsWithTheVideoQuality() {
    ...
    @Test
    fun create_aFeatureGroupSessionWithoutAMappableQuality_asksOnlyForStabilization() {
    ...
    @Test
    fun create_aFeatureGroupSession_constructsASessionConfigWithoutThrowing() {
        val plan = buildPlan(featureGroupRequest())
    ...
    @Test
    fun create_aPlainSession_constructsASessionConfigWithoutThrowing() {
