...
class ResolveCaptureLocationTest {
    ...
    fun invoke_whenNotRequested_leavesTheRepositoryAlone() {
        runTest {
            assertEquals(CaptureLocation.NotRequested, resolveCaptureLocation(false))
    ...
    fun invoke_withoutAFix_reportsItUnavailable() {
        runTest {
            ...
            assertEquals(CaptureLocation.Unavailable, resolveCaptureLocation(true))
        }
    }
    ...
    fun invoke_withAFix_returnsIt() {
        runTest {
            ...
            assertEquals(CaptureLocation.Found(location), resolveCaptureLocation(true))
        }
    }
}
