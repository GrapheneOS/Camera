...
class CustomGrid @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (mActivity.config.gridType == CamConfig.Grid.GOLDEN_RATIO) {
            ...
            canvas.drawLine(width / seed * 2f, 0f, width / seed * 2f, previewHeight.toFloat(), paint)
            canvas.drawLine(width / seed, 0f, width / seed, previewHeight.toFloat(), paint)
            canvas.drawLine(0f, previewHeight / seed * 2f,
                width.toFloat(), previewHeight / seed * 2f, paint)
            canvas.drawLine(0f, previewHeight / seed, width.toFloat(), previewHeight / seed, paint)

            if(seed == 4f) {
                canvas.drawLine(width / seed * 3f, 0f, width / seed * 3f, previewHeight.toFloat(), paint)
                canvas.drawLine(0f, previewHeight / seed * 3f,
